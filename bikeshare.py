...
def user_stats(df, city):
    ...
    if city != 'washington':
        ...
        earliest = int(sorted(df.groupby(['Birth Year'])['Birth Year'], reverse=True)[0][0])
        recent = int(sorted(df.groupby(['Birth Year'])['Birth Year'])[0][0])
    ...
    x = 1
    while True:
        rawData = input('\nWould you like the raw data? Enter yes or no: \n')
